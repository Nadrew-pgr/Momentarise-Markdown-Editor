...
- `openWritableMarkdownFile()` and `createImportedCopyDocument()` report whether the opened source is Markdown, lightweight source text, or standalone SVG artifact source.
