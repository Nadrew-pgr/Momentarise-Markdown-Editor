...
- Rich cell editing, keyboard navigation, final-cell row append, explicit body-row insert/delete, and explicit column insert/delete are implemented in MME-0055/MME-0072/MME-0073. Row/column reorder and spreadsheet/CSV-like paste remain backlog and require explicit Markdown-safe serialization.
...
- Table rendering and first rich table editing baseline promoted as `MME-0040` and `MME-0055`; explicit body-row operations are implemented as `MME-0072`; explicit column operations are implemented as `MME-0073`; reorder and spreadsheet-like paste remain backlog.
