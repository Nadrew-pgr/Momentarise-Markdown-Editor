...
- Rich cell editing, keyboard navigation, final-cell row append, explicit body-row insert/delete, explicit column insert/delete, and row/column reorder are implemented in MME-0055/MME-0072/MME-0073/MME-0074. Strict spreadsheet/TSV clipboard paste is promoted as MME-0075; quoted CSV/HTML-table paste and file conversion remain backlog.
...
- MME-0075 spreadsheet/TSV paste review: review paste discoverability, replacement/expansion behavior, final-cell focus feedback, literal punctuation display, undo/redo feel, nested table reachability, large-matrix and wide-table horizontal scrolling, full-editor focus outline, diagnostics-chip placement, and constrained layout.
