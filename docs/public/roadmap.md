...
- Standard top-level GFM tables and unique plain-paragraph footnotes have preservation-first Rich editing and insertion baselines.
...
- Complex, nested-block, and structural table and footnote editing.
- Live preview parity.
