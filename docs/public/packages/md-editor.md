...
- `classifyEditorDocumentKind` and file-name helpers route supported Markdown, HTML artifact, SVG artifact, and lightweight source files.
- `editorModesForDocumentKind` keeps Markdown, HTML artifact, SVG artifact, and lightweight source mode controls honest.
