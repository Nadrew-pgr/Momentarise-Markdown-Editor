...
assertEqual(definitions.length, 3, "safe top-level, ordered-item, and task-item fences must be editable");
...
for (const fallbackText of ["const indented = true;", "const quoted = true;"]) {
  let rejected = false;
  try {
