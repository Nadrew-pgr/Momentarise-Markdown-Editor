...
const sourceRequirements = [
  ...
  ["last document restore storage key", "lastDemoDocumentStorageKey"],
  ["last document persist", "persistRestorableDocument"],
  ["last document restore", "restoreLastDemoDocument"],
