...
- Keep fenced-code, safe-table, and safe-callout behavior compatible; keep quote-contained code, mixed multiple-container items, raw HTML, and nested-container definitions source-only.
