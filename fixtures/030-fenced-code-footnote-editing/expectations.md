...
- Keep safe callouts and inert raw-HTML source compatible; keep quote-contained code, mixed multiple-container items, and nested-container definitions source-only. Safe indented code is covered by MME-0067 and safe tables by MME-0068.
