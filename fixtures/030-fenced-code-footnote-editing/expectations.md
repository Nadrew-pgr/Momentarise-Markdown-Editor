...
- Mount the unique top-level `code-top`, `code-list`, and `code-task` definitions as semantic editable Rich definitions.
...
- Keep indented code, quote-contained code, mixed multiple-container items, tables, callouts, raw HTML, and nested-container definitions source-only.
