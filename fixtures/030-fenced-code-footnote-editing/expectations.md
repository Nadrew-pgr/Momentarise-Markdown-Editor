...
- Keep safe callouts compatible; keep quote-contained code, mixed multiple-container items, raw HTML, and nested-container definitions source-only. Safe indented code is covered by MME-0067 and safe tables by MME-0068.
