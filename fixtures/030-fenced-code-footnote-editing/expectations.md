...
- Keep quote-contained code, mixed multiple-container items, callouts, raw HTML, and nested-container definitions source-only; safe indented code is covered by MME-0067 and safe tables by MME-0068.
