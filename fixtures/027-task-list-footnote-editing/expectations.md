...
- Mount safe loose multi-paragraph task items semantically; keep multiple nested children, quotes, unsafe content, and nested-container definitions source-only.
