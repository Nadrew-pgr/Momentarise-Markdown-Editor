...
- Mount safe loose multi-paragraph task items and paragraph-only item quotes semantically; keep multiple container children, nested quotes, unsafe content, and nested-container definitions source-only.
