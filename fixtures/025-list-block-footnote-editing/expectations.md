...
- Mount safe task and loose multi-paragraph lists plus paragraph-only quotes as semantic Rich definitions; keep raw HTML, nested-container definitions, duplicates, malformed definitions, stale source, and unmappable ranges source-only.
