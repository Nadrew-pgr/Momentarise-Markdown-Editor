...
- Mount safe task lists as semantic Rich definitions; keep loose or multi-paragraph list items, quotes, raw HTML, nested-container definitions, duplicates, malformed definitions, stale source, and unmappable ranges source-only.
