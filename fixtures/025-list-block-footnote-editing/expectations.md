...
- Mount safe task and loose multi-paragraph lists, paragraph-only quotes, and direct inline HTML as semantic Rich definitions; keep block HTML, nested-container definitions, duplicates, malformed definitions, stale source, and unmappable ranges source-only.
