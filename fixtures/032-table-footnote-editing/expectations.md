...
- Keep fenced/indented code and safe-callout behavior compatible; keep quote-contained tables, mixed multiple-container items, unsafe cells, raw HTML, and nested-container definitions source-only.
