...
- Keep fenced/indented code behavior compatible and keep quote-contained tables, mixed multiple-container items, unsafe cells, callouts, raw HTML, and nested-container definitions source-only.
