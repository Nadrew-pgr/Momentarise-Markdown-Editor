...
- Mount recursively safe mixed standard/task and loose nested lists as semantic Rich definitions; keep multiple nested child blocks, quotes, raw HTML, nested-container definitions, duplicates, malformed definitions, stale source, and unmappable ranges source-only.
