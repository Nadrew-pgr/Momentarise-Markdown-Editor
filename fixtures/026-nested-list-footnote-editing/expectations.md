...
- Keep task lists, loose or multi-paragraph items, multiple nested child blocks, quotes, raw HTML, nested-container definitions, duplicates, malformed definitions, stale source, and unmappable ranges source-only.
