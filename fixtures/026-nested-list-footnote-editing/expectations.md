...
- Mount recursively safe mixed standard/task and loose nested lists plus paragraph-only item quotes as semantic Rich definitions; keep multiple container children, nested quotes, raw HTML, nested-container definitions, duplicates, malformed definitions, stale source, and unmappable ranges source-only.
