...
- Mount recursively safe mixed standard/task and loose nested lists, paragraph-only item quotes, and direct inline HTML as semantic Rich definitions; keep multiple container children, nested quotes, block HTML, nested-container definitions, duplicates, malformed definitions, stale source, and unmappable ranges source-only.
