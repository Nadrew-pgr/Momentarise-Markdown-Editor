...
- Mount one paragraph-only blockquote child semantically; keep multiple containers, nested quotes, code, tables, callouts, raw HTML, nested-container definitions, duplicates, stale source, and unmappable layouts source-only.
