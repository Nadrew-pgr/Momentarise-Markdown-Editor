...
- Mount one paragraph-only blockquote child, one safe indented-code child, and one safe table child semantically; keep multiple containers, nested quotes, callouts, raw HTML, nested-container definitions, duplicates, stale source, and unmappable layouts source-only.
